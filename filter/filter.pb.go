...
func (m *StringFilter) CloneMessageVT() any {
	return m.CloneVT()
}
...
func (x *StringFilter) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.NotEmpty || s.HasField("not_empty") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("not_empty")
	...
	if x.HasPrefix != "" || s.HasField("has_prefix") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("has_prefix")
		s.WriteString(x.HasPrefix)
	}
	if x.HasSuffix != "" || s.HasField("has_suffix") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("has_suffix")
...
func (m *StringFilter) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: StringFilter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: StringFilter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field Empty", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field NotEmpty", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field Re", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 6:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field HasPrefix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 7:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field HasSuffix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 8:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field Contains", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
