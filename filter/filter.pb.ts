...
export const StringFilter = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<StringFilter | StringFilter[]>
      | Iterable<StringFilter | StringFilter[]>,
  ...
  fromJSON(object: any): StringFilter {
    return {
      ...
      notEmpty: isSet(object.notEmpty)
        ? globalThis.Boolean(object.notEmpty)
        : false,
      ...
      hasPrefix: isSet(object.hasPrefix)
        ? globalThis.String(object.hasPrefix)
        : '',
      hasSuffix: isSet(object.hasSuffix)
        ? globalThis.String(object.hasSuffix)
        : '',
  ...
  create<I extends Exact<DeepPartial<StringFilter>, I>>(
    base?: I,
  ): StringFilter {
    return StringFilter.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<StringFilter>, I>>(
    object: I,
  ): StringFilter {
    const message = createBaseStringFilter()
