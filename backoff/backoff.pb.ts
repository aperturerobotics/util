...
export interface Backoff {
  ...
  exponential: Exponential | undefined
...
export const Backoff = {
  ...
  fromJSON(object: any): Backoff {
    return {
      backoffKind: isSet(object.backoffKind)
        ? backoffKindFromJSON(object.backoffKind)
        : 0,
      exponential: isSet(object.exponential)
        ? Exponential.fromJSON(object.exponential)
        : undefined,
      constant: isSet(object.constant)
        ? Constant.fromJSON(object.constant)
        : undefined,
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Backoff>, I>>(object: I): Backoff {
    ...
    message.exponential =
      object.exponential !== undefined && object.exponential !== null
...
export const Exponential = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<Exponential | Exponential[]>
      | Iterable<Exponential | Exponential[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
  ...
  fromJSON(object: any): Exponential {
    return {
      initialInterval: isSet(object.initialInterval)
        ? globalThis.Number(object.initialInterval)
        : 0,
      multiplier: isSet(object.multiplier)
        ? globalThis.Number(object.multiplier)
        : 0,
      maxInterval: isSet(object.maxInterval)
        ? globalThis.Number(object.maxInterval)
        : 0,
      randomizationFactor: isSet(object.randomizationFactor)
        ? globalThis.Number(object.randomizationFactor)
        : 0,
      maxElapsedTime: isSet(object.maxElapsedTime)
        ? globalThis.Number(object.maxElapsedTime)
        : 0,
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Exponential>, I>>(
    object: I,
  ): Exponential {
    const message = createBaseExponential()
...
export const Constant = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<Constant | Constant[]>
      | Iterable<Constant | Constant[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
